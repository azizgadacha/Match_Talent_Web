 ...
 */
final class Version20230323151845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id_annonce INT AUTO_INCREMENT NOT NULL, id_quiz INT DEFAULT NULL, id_categorie INT DEFAULT NULL, id_utilisateur INT DEFAULT NULL, titre VARCHAR(50) NOT NULL, nom_societé VARCHAR(50) NOT NULL, datedebut DATE NOT NULL, datefin DATE NOT NULL, description VARCHAR(50) NOT NULL, type_contrat VARCHAR(50) NOT NULL, INDEX IDX_F65593E52F32E690 (id_quiz), INDEX IDX_F65593E5C9486A13 (id_categorie), INDEX IDX_F65593E550EAE44 (id_utilisateur), PRIMARY KEY(id_annonce)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE postulation (id_annonce INT NOT NULL, id_utilisateur INT NOT NULL, id_file VARCHAR(255) DEFAULT NULL, etat VARCHAR(50) NOT NULL, date DATE NOT NULL, INDEX IDX_DA7D4E9B28C83A95 (id_annonce), INDEX IDX_DA7D4E9B50EAE44 (id_utilisateur), INDEX IDX_DA7D4E9B7BF2A12 (id_file), PRIMARY KEY(id_annonce, id_utilisateur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
