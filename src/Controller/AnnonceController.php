...
class AnnonceController extends AbstractController
{
    ...
    public function index(AnnonceRepository $annonceRepository, UtilisateurRepository $utilisateurRepository, RoleRepository $roleRepository): Response
    {
       ...
       echo gettype( $role);
       echo gettype( $demandeur);
       $isDemander = ($role==$demandeur);
      //  echo "h ".gettype ($isDemander).$isDemander;

       echo "salem sahbi". var_export($isDemander)."  jjjjj";
       //$isDemander = ($role->getNomRole())=== 'DEMANDEUR';
       //echo "jjjjffef ". $isDemander."     rrrr";
       //echo  $isDemander;
