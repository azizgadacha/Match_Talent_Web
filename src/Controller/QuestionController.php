...
class QuestionController extends AbstractController
{
    ...
    public function new($idQuiz,QuizRepository $quizRepository,Request $request, QuestionRepository $questionRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_question_get_questions_by_id_quiz', ["idQuiz"=>$idQuiz], Response::HTTP_SEE_OTHER);
        }
    ...
    public function edit(Request $request, Question $question, QuestionRepository $questionRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_question_get_questions_by_id_quiz', ["idQuiz"=>$question->getQuizAssocier()->getIdQuiz()], Response::HTTP_SEE_OTHER);
        }
    ...
    {
        $idQuiz=$question->getQuizAssocier()->getIdQuiz();
